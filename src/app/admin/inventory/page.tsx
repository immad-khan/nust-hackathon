...
export default function AdminInventoryPage() {
  ...
  async function loadInventory(headers: Record<string, string>) {
    setLoading(true);
    setNotice("");
    try {
  ...
  return (
    ...
    >
      {({ authHeaders }) => {
        ...
        useEffect(() => {
          void loadInventory(authHeaders());
        }, []);
          ...
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              ...
              <div className="flex items-center gap-2 overflow-x-auto pb-1 md:pb-0">
                ...
                <button
                  onClick={() => void loadInventory(authHeaders())}
                      ...
                      {filteredItems.map((item) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            {/* Stock Count (with color highlights: RED < 10, YELLOW 10-20, GREEN > 20) */}
                            ...
                            <td className="px-5 py-4 text-right whitespace-nowrap">
                              <div className="inline-flex items-center gap-1.5 border border-line rounded-sm bg-cream p-0.5">
                                <button
                                  ...
                                  onClick={() => void updateStock(item, item.stock - 1, authHeaders())}
                                ...
                                <input
                                  ...
                                  onChange={(e) => {
                                    ...
                                    if (!isNaN(val)) {
                                      void updateStock(item, val, authHeaders());
                                    }
                                  }}
