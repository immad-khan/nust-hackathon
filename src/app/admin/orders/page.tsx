...
function getStatusBadge(status: string) {
  ...
  // Default blue for processing/shipped
  return (
...
export default function AdminOrdersPage() {
  ...
  async function loadOrders(headers: Record<string, string>) {
    setLoading(true);
    setNotice("");
    try {
  ...
  async function updateStatus(orderNumber: string, nextStatus: string, headers: Record<string, string>) {
          ...
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
              ...
              <div className="flex items-center gap-2 overflow-x-auto pb-1 md:pb-0">
                ...
                <button
                  onClick={() => void loadOrders(authHeaders())}
                    ...
                    <tbody className="divide-y divide-line/60">
                      {filteredOrders.map((order) => (
                        ...
                        >
                          ...
                          {/* Items (list of products in that order) */}
                          ...
                          {/* Synced to Notion (small purple badge saying Synced) */}
                          <td className="px-5 py-4 whitespace-nowrap">
                  ...
                  <div className="mt-6 border-t border-line pt-4 flex flex-wrap items-center justify-between gap-3">
                    <div className="flex items-center gap-2">
                      ...
                      <select
                        ...
                        onChange={(e) => void updateStatus(selectedOrder.orderNumber, e.target.value, authHeaders())}
